...
completely before changing agent behavior. Root and Child are topology, not
roles or different capability levels. Do not duplicate or inject the prompt
from this file.
...
Keep runtime changes aligned with equal Agents, recursive delegation,
Task-wide concurrency limits, Goal-scoped Commitments,
