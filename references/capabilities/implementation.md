...
Follow `references/engineering-style.md`. Preserve the repository's language idioms and existing conventions. Keep one handoff to a cohesive batch; continue later work from the checkpoint and repository.
